...
var e = {
    ...
    floatButton: function () {
        ...
        var backBtn = e.select('.float-button');
        if (e.isVariableDefined(backBtn)) {
            var add_class_on_scroll = () => backBtn.addClass("float-button-show");
            var remove_class_on_scroll = () => backBtn.removeClass("float-button-show");
